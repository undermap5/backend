...
import org.bbosiregi.demo.util.error.ErrorResponse;
...
//        log.error("handleCustomException: {}", e.getErrorCode());
        ...
        final ErrorResponse response = ErrorResponse.of(message, errorCode);
     ...
     * ref https:
     * //docs.spring.io/spring/docs/current/spring-framework-reference/web.html#mvc-ann-modelattrib-method-args
     */
    ...
    public ResponseEntity<ErrorResponse> handleQueryTimeoutException(QueryTimeoutException e) {
        log.error("failToExecuteQuery, {}", e.getMessage());
        final ErrorResponse response = ErrorResponse.of(ErrorCode.INTERNAL_SERVER_ERROR);
        return new ResponseEntity<>(response,HttpStatus.INTERNAL_SERVER_ERROR);
    }
//    @ExceptionHandler(HttpMessageNotReadableException.class)
//    public ResponseEntity<ErrorResponse> handleHttpMessageNotReadableException(HttpMessageNotReadableException e) {
//        log.error("HttpMessageNotReadable, {}", e.getMessage());
